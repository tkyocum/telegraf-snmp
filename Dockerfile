...
RUN export  DEBIAN_FRONTEND=noninteractive && \
     ...
     wget https://global.download.synology.com/download/Document/MIBGuide/Synology_MIB_File.zip && unzip Synology_MIB_File.zip && mv Synology_MIB_File/* /usr/share/snmp/mibs && \
